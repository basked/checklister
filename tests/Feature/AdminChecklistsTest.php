...
class AdminChecklistsTest extends TestCase
{
    ...
    public function test_manage_checklists()
    {
        ...
        $response = $this->post($checklists_url, ['name' => 'First checklist']);
        $response->assertRedirect('welcome');
    ...
    {
        $checklist_group = ChecklistGroup::factory()->create();
        $checklist = Checklist::factory()->create(['name' => 'bas', 'checklist_group_id' => $checklist_group->id]);
    ...
    {
        $checklist_group = ChecklistGroup::factory()->create();
        $checklist = Checklist::factory()->create(['name' => 'Checklist1', 'checklist_group_id' => $checklist_group->id]);
